...
# Prompt for database name, username, and password (input from the right)
...
# Run mysql_secure_installation (this may still ask a few questions but should be more streamlined)
